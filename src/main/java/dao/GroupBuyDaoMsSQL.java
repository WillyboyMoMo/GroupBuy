...
public class GroupBuyDaoMsSQL implements GroupBuyDao {
	private static GroupBuyDao _instance = new GroupBuyDaoMsSQL();
	
	private JdbcTemplate jdbcTemplate;
	
	private GroupBuyDaoMsSQL() {
		String dbURL = "jdbc:sqlserver://localhost:1433;databaseName=group_buy;encrypt=true;trustServerCertificate=true\r\n";
		String username = "sa";
		String password = "Pa55w.rd";
		
		// 創建 DriverManagerDataSource
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver"); // MsSQL 驅動
